...
export class Image {
    ...
    DOM = {
        el: null,   // Holds the reference to the main DOM element with class 'effects__img'.
        inner: null, // Holds the reference to the inner DOM element with class 'effects__img-inner'.
    };
     ...
     * @param {HTMLElement} DOM_el - The main DOM element for the image, expected to have a child with class 'effects__img-inner'.
     */
    constructor(DOM_el) {
        // Assign the provided DOM element to the 'el' property of the 'DOM' object.
        this.DOM.el = DOM_el;
        // Find and assign the inner element (with class 'effects__img-inner') to the 'inner' property of the 'DOM' object.
        this.DOM.inner = this.DOM.el.querySelector('.effects__img-inner');
